...
float[][] panfletoFormatoButtons = new float[7][4];
String[] panfletoFormatoLabels = { "A4 V", "A4 H", "1080x1350", "1080x1920 px", "1920x1080 px", "1063x591 cm", "4373x1640 px" };
